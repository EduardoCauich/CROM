...
<body>
  ...
  <?php
    ...
    include "header.php";
  ?>
  <section class="tituloproyectos slide">
    <div class="ancho">
      <h2 class="tituloblanco wow animate__animated animate__bounceInLeft animate__slow">PROYECTOS</h2>
      <hr class="linearoja wow animate__animated animate__bounceInLeft animate__slow">
    </div>
  </section>
  <br>
  <section class="infoproyectos ancho">
